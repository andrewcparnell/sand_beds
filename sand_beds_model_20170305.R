...
par(mfrow=c(5,1))
plot(SB7_min_cal, xlim = c(200, 1600))
plot(SB7_min_2_cal, xlim = c(200, 1600))
plot(SB7_min_3_cal, xlim = c(200, 1600))
plot(SB7_min_4_cal, xlim = c(200, 1600))
plot(SB7_max_cal, xlim = c(200, 1600))
par(mfrow=c(1,1))
